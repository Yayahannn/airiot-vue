...
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('moment'), require('xadmin')) :
typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'moment', 'xadmin'], factory) :
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.xadminI18n = {}, global._, global.moment, global.xadmin));
}(this, (function (exports, _, moment, app) { 'use strict';
...
var ajax_1 = createCommonjsModule(function (module, exports) {
...
unwrapExports(ajax_1);

var commonjs$2 = createCommonjsModule(function (module, exports) {
...
var _ajax2 = _interopRequireDefault(ajax_1);
...
unwrapExports(commonjs$2);

/* eslint no-var: 0 */
var main$1 = commonjs$2.default;

var i18nextXhrBackend = main$1;
var default_1$1 = main$1;
i18nextXhrBackend.default = default_1$1;
...
var commonjs$1 = createCommonjsModule(function (module, exports) {
...
unwrapExports(commonjs$1);

var i18nextLocalstorageCache = commonjs$1.default;
...
/* eslint no-var: 0 */
var main = commonjs.default;

var i18nextBrowserLanguagedetector = main;
var default_1 = main;
i18nextBrowserLanguagedetector.default = default_1;
...
var zh_Hans = {
	...
	Back: Back,
	"Batch Change Items": "批量修改",
	"Batch Delete Items": "批量删除",
	"Batch Save {{object}} success": "批量保存 {{object}} 成功",
	Cancel: Cancel,
	"Captcha Code": "验证码",
	Change: Change,
	...
	Clear: Clear,
	"Clear order": "取消排序",
	"Click to refresh captcha code": "点击更新验证码",
	Close: Close,
	Columns: Columns,
	Comfirm: Comfirm,
	"Comfirm Delete": "确认删除",
	"Confirm to delete selected items": "请确认删除选择的条目",
	"Create {{name}}": "创建{{name}}",
	"Create {{object}} success": "添加{{object}}成功",
	"Create {{title}}": "添加{{title}}",
	"Customize page size": "自定义每页数目",
	"Date Joined": "注册日期",
	Delete: Delete,
	"Delete {{object}} success": "删除{{object}}成功",
	Description: Description,
	Edit: Edit,
	"Edit {{name}}": "编辑{{name}}",
	"Edit {{title}}": "修改{{title}}",
	Email: Email,
	"Email Verified": "Email已验证",
	"Enter page size": "输入每页数目",
	Filter: Filter,
	"Filter Form": "数据过滤表单",
	"Forgot password": "忘记密码",
	"Have account": "已注册账号",
	"Incorrect old password": "原密码输入错误",
	...
	"Please Login": "请您登录",
	"Please Signup": "请您注册",
	"Please be sure to complete all field": "请您填写完整所有表单项",
	"Please input the value to batch change items": "批量修改数据",
	"Register Email": "注册的Email",
	"Register success": "注册用户成功",
	"Repeat Password": "重复密码",
	"Reset Password": "重置密码",
	"Reset password success": "重置密码成功",
	Role: Role,
	Save: Save,
	"Save {{object}} success": "保存{{object}}成功",
	Search: Search,
	"Search {{label}}": "搜索{{label}}",
	"Select {{label}}": "选择{{label}}",
	"Send Email to Reset Password": "发送重置密码邮件",
	"Send reset password email success": "发送重置密码邮件成功，请查收邮件",
	"Send verify code to your email, please check": "已发送重置密码邮件到您的邮箱，请查收邮件",
	"Set page size": "设置每页数目",
	"Set {{size}} per page": "每页{{size}}条",
	"Sign In": "登录",
	"Sign Up": "注册",
	Signup: Signup,
	"Sort ASC": "正序",
	"Sort DESC": "倒序",
	Success: Success,
	"Successfully logged out": "成功退出",
	User: User,
	"User Name": "用户名",
	Username: Username,
	"Verify email success, please login": "邮箱验证成功，请您登录",
	loading: loading,
	"please login": "请您登录",
	"please signup": "立即注册",
	"reset password": "重置密码",
	"Fuzzy query": "模糊查询",
	"Exact query": "精确查询",
	"type a few characters to kick off remote search": "请输入内容进行搜索",
	"Type to search": "请输入关键字搜索",
	"{{count}} record selected": "已选择 {{count}} 条数据",
	"{{count}} records": "{{count}} 条数据",
	"{{name}} Detail": "{{name}}详情",
	"{{name}} List": "{{name}}列表",
	"{{size}} per page": "每页{{size}}条",
...
var _t = function _t() {
  ...
  return (_app$context = app__default['default'].context)._t.apply(_app$context, arguments);
};
var index = {
  name: 'xadmin.i18n',
  items: {
  ...
  context: function context(app) {
    return function (context, cb) {
      ...
      var _app$get = app.get('config'),
          locale = _app$get.locale;

      for (var ln in resources) {
        resources[ln] = ___default['default'].merge.apply(___default['default'], [{}].concat(_toConsumableArray$1(resources[ln])));
      }

      i18next.use(i18nextXhrBackend) // or any other backend implementation
      .use(i18nextLocalstorageCache) // or any other cache implementation
      .use(i18nextBrowserLanguagedetector) // or any other implementation
      .init(_objectSpread2({
        debug: false,
        lng: 'en',
        fallbackLng: false,
        ...
        moment__default['default'].locale(locale && locale.moment || 'en');
