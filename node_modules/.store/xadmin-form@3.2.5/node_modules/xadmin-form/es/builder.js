...
var FieldWrapComponent = (_ref) => {
  ...
  return FieldComponent.useGroup === false ? /*#__PURE__*/React.createElement(FieldComponent, _extends({}, props, {
    field: newField,
    group: FieldGroup
  })) : /*#__PURE__*/React.createElement(FieldGroup, _extends({}, props, {
    field: newField
...
var objectBuilder = (fields, render, option) => {
  var fields_defined = option.fieldsDefined ? _objectSpread(_objectSpread({}, app.get('form_fields')), option.fieldsDefined) : app.get('form_fields');
...
var fieldBuilder = function fieldBuilder(field, option) {
  ...
  if (field.render) {
    ...
    var FieldGroup = group || (option && option.group ? option.group : C('Form.FieldGroup'));
